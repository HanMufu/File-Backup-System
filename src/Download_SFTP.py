...
#         print('start downloading the file：' + remote_dir_path)
#         sub_remote = remote_dir_path.replace('\\', '/')
#         local_dir_name = os.path.join(local_dir_path + filename_at_client)
#         sftp_obj.get(sub_remote, local_dir_name)


# def downloadhelper(remote_dir, local_dir, filename_at_client):
#     """ server connection information"""
#     host_name = '35.223.248.16'
#     user_name = 'sshtest'
#     password = 'EDGELOVESCAMRY'
...
#     # download the remote file
#     # print(sftp.stat(remote_dir))
#     down_from_remote(sftp, remote_dir, local_dir, filename_at_client)
#
#     """close the connection"""
#     t.close()
